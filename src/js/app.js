...
var siteActions = [
  ...
  {
    element: "#new-home-customer-carousel",
    action: require("./widgets/el-new-hp-customer-carousel/"),
  },
  {
  ...
  },
  {
    ...
    action: function () {
      MakeTabs(
        document.querySelectorAll("#services-cs-tabs .tab"),
        document.querySelectorAll("#services-cs-tabs .services-cs-slide"),
        "data-tab-index",
        "active"
      );
    },
  },
  {
    ...
    action: function () {
      MakeTabs(
        document.querySelectorAll("#services-services-tabs .tab a"),
        document.querySelectorAll("#services-services-tabs .services-slide"),
        "data-tab-index",
        "active"
      );
    },
