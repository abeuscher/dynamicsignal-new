require("../js/utils/remove-class.js");
...
var removeClassFromClass = require("../js/utils/remove-class-from-class.js");

var FormHandler = require("../js/form-handler/index.js");

var siteSettings = {
  "imagePath": "/wp-content/themes/ds-uk/images/",
  "videoPath": "",
  "gdprCookie": "ds-gdpr-uk",
  "sessionCookie": "ds-count",
  "ctaBar": require("../js/cta-bar.json"),
  "templates": {  
    "adwordsGrid": require("../js/inc/ad-words-grid.pug"),
    "adwordsLogoGarden": require("../js/inc/ad-words-logo-garden.pug"),
    "homePageLogo": require("../js/inc/home-logo-slide.pug"),
    "logoTerminalGrid": require("../js/inc/logo-terminal-grid.pug"),
    "logoPartnersGrid": require("../js/inc/logo-partners-grid.pug"),
    "partnersPageLogo": require("../js/inc/partners-logo-slide.pug"),
    "customerTile": require("../js/inc/customer-tile.pug"),
    "customerQuote": require("../js/inc/customer-quote.pug"),
    "partnersTestimonial": require("../js/inc/partner-testimonial.pug"),
    "careerVideoSlide": require("../js/inc/career-video-slide.pug"),
    "featuredJob": require("../js/inc/featured-job.pug"),
    "testimonialSlide": require("../js/inc/testimonial-slide.pug"),
    "productDisplay": require("../js/inc/product-display.pug"),
    "pagerThumb": require("../js/inc/pager-thumb.pug"),
    "homeSlides": require("../js/inc/homepage-slides.pug"),
    "servicesLogos": require("../js/inc/services-logos.pug"),
    "connectorPanel": require("../js/inc/connector-panel.pug"),
    "connectorInfo": require("../js/inc/connector-info.pug"),
    "useCaseQuote": require("../js/inc/use-case-quote.pug"),
    "jobListing": require("../js/inc/job-listing.pug"),
    "ctaBar": require("../js/inc/cta-bar.pug"),
    "summitCtaBar": require("../js/inc/summit-cta.pug"),
    "noEvents": require("../js/inc/no-events.pug"),
    "eventListing": require("../js/inc/event-listing.pug"),
    "pastEventListing": require("../js/inc/past-event-listing.pug"),
    "buttonPastEvents": require("../js/inc/button-past-events.pug"),
    "jobFilter": require("../js/inc/job-filter.pug"),
    "backgroundPicker": require("../js/inc/header-picker.pug"),
    "gdprPopup": require("../js/inc/gdpr-popup.pug"),
    "sdrQuote": require("../js/inc/sdr-quote.pug"),
    "modalVideo": require("../js/inc/modal-video-slide.pug"),
    "videoCarousel": require("../js/inc/video-carousel.pug"),
    "whatisSlide": require("../js/inc/whatis-carousel-slide.pug")
  },
  "breakpoints": {
    "xs": 0,
    "s": 641,
