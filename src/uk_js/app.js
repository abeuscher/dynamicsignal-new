...
var JobList = require("../js/job-handler/index.js");
var JobFilter = require("../js/job-handler/job-filter.js");
var FormHandler = require("../js/form-handler/index.js");
var VideoHandler = require("../js/video-handler/index.js");
var DigitCounter = require("../js/digit-counter/index.js");
...
var siteSettings = {
  ...
  "ctaBar": require("../js/cta-bar.json"),
  "fontApiKey": "AIzaSyCqr2-oB5Ck52ZRAxrztzvJNdiaRJyKUL0",
  "templates": {
    "adwordsGrid": require("../js/inc/ad-words-grid.pug"), // Grid for Adwords landing pages
    "adwordsLogoGarden": require("../js/inc/ad-words-logo-garden.pug"), // Logo garden for adwords landing pages
    "logoTerminalGrid": require("../js/inc/logo-terminal-grid.pug"), // Flipping Logo Slides
    "logoPartnersGrid": require("../js/inc/logo-partners-grid.pug"), // Flipping logo slides for partners page
    "customerTile": require("../js/inc/customer-tile.pug"), // Logo grid for Customers page
    "customerQuote": require("../js/inc/customer-quote.pug"), // Quote carousel for customers page
    "partnersTestimonial": require("../js/inc/partner-testimonial.pug"), // Testimonials opn agency partners page
    "careerVideoSlide": require("../js/inc/career-video-slide.pug"), // Video slide on careers page
    "featuredJob": require("../js/inc/featured-job.pug"), // Featured job popout on careers page
    "demoRequestModal": require("../js/inc/demo-request-modal.pug"), // Modal Demo Request form
    "servicesLogos": require("../js/inc/services-logos.pug"), // Logos for integrations section of services page
    "connectorPanel": require("../js/inc/connector-panel.pug"), // On connectors page - may still be in use
    "connectorInfo": require("../js/inc/connector-info.pug"), // On connectors page - may still be in use
    "jobListing": require("../js/inc/job-listing.pug"), // Job listing for careers page
    "ctaBar": require("../js/inc/cta-bar.pug"), // For CTA Bar - Soon to expire
    "noEvents": require("../js/inc/no-events.pug"), // No events temlate for events page
    "eventListing": require("../js/inc/event-listing.pug"), // Event Listing
    "pastEventListing": require("../js/inc/past-event-listing.pug"), // Past event listing
    "pastEventWide": require("../js/inc/past-event-wide.pug"), // Past events full page layout
    "eventBreadcrumb": require("../js/inc/events-breadcrumbs.pug"), // Events breadcrumbs
    "pasteventBreadcrumb": require("../js/inc/past-events-breadcrumbs.pug"), // BReadcrumbs for past events page
    "buttonPastEvents": require("../js/inc/button-past-events.pug"), // Button for past events
    "jobFilter": require("../js/inc/job-filter.pug"), // Job Filter for Careers Page
    "gdprPopup": require("../js/inc/gdpr-popup.pug"), // Popup GDPR warning
    "sdrQuote": require("../js/inc/sdr-quote.pug") // Quote carousel for SDR specific career page
  },
  "breakpoints": {
    "xs": 0,
    "s": 641,
